    ...
    if (camera)
    {
        AddTool("self.camera.take_photo",
                ...
                [camera](const PropertyList &properties) -> ReturnValue
                {
                    ...
                    std::string b64 = camera->GetJpegBase64(80);
                    std::cout << "Captured photo size: " << b64.size() << " bytes" << std::endl;
                    // std::cout << "Captured photo data in Base64: " << b64.substr(0, 50) << "..." << std::endl;
                    // const size_t chunkSize = 1024;
                    // for (size_t offset = 0; offset < b64.size(); offset += chunkSize)
                    // {
                    //     std::cout << b64.substr(offset, std::min(chunkSize, b64.size() - offset));
                    // }
                    // std::cout << std::endl;
                    // std::cout << "Camera response: " << result << std::endl;
                    return b64;
                });
    }
